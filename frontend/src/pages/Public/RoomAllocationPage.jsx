...
const RoomAllocationPage = () => {
  ...
  const rooms = [
    ...
    { 
      ...
      beds: [
        { bedNumber: 1, occupants: [
          { name: "Shibli", role: "student", gender: "male" },
    ...
    { 
      ...
      beds: [
        ...
        { bedNumber: 2, occupants: [
          ...
          { name: "Rezoan", role: "student", gender: "male" }
        ]}
      ],
      type: 'male'
    }
                      ...
                      {rooms.filter(r => r.type === 'faculty').map((room) => (
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <span className="px-2 py-1 bg-purple-600 text-white rounded-full text-[8px] md:text-[10px] font-bold shadow-lg">
                              FACULTY
                            </span>
                          </div>
