...
const seatAllocationMap = {
    ...
    jasToCum: {
      ...
      F1: 7, F2: 8, // Sadik (7), Takbir (8)
      F3: 9, F4: 10, // Sibly (9), Noman (10)
      G1: 11, G2: 12, // Tahmid (11), Rafid (12)
      H3: 13, H4: 14, // Makky (13), Durjoy (14)
      G3: 15, G4: 16, // Nehal (15), Fahim (16)
      E1: 17, E2: 18, // Sayed (17), Biswajit (18)
      E3: 19, E4: 20, // Ramjan (19), Abrar (20)
      A1: 21, A2: 22, // Oveshek (21), Tapu (22)
      A3: 23, A4: 24, // Tanvir (23), Samit (24)
      D1: 25, D2: 26, // Limon (25), Joy (26)
      D3: 27, D4: 28, // Risan (27), Rezowan (28)
    ...
    coxToCum: {
      ...
      F1: 13, F2: 14, // Makky (13), Durjoy (14)
      G1: 15, G2: 16, // Nehal (15), Fahim (16)
      A3: 17, A4: 18, // Sayed (17), Biswajit (18)
      A1: 19, A2: 20, // Ramjan (19), Abrar (20)
      E3: 21, E4: 22, // Oveshek (21), Tapu (22)
      E1: 23, E2: 24, // Tanvir (23), Samit (24)
      D3: 25, D4: 26, // Limon (25), Joy (26)
      D1: 27, D2: 28, // Risan (27), Rezowan (28)
      F3: 29, F4: 30 // Azaz (29), Arif (30)
    },
    
    // Leg 4: Cumilla to Jashore (P2, P1)
    cumToJas: {
      C1: 1, C2: 1, C3: 1, C4: 2, B1: 4, B2: 3, B3: 6, B4: 5,
      F1: 8, F2: 7, // Takbir (8), Sadik (7)
      F3: 10, F4: 9, // Noman (10), Sibly (9)
      G1: 12, G2: 11, // Rafid (12), Tahmid (11)
      H3: 14, H4: 13, // Durjoy (14), Makky (13)
      G3: 16, G4: 15, // Fahim (16), Nehal (15)
      E1: 18, E2: 17, // Biswajit (18), Sayed (17)
      E3: 20, E4: 19, // Abrar (20), Ramjan (19)
      A1: 22, A2: 21, // Tapu (22), Oveshek (21)
      A3: 24, A4: 23, // Samit (24), Tanvir (23)
      D1: 26, D2: 25, // Joy (26), Limon (25)
      D3: 28, D4: 27, // Rezowan (28), Risan (27)
