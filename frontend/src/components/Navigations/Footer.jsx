        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-gray-700 hover:bg-indigo-600 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/about" className="text-gray-400 hover:text-indigo-400 transition-colors duration-200">
                  About Us
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/security" className="text-gray-400 hover:text-indigo-400 transition-colors duration-200">
                  Security
                </Link>
              </li>
              <li>
                <Link to="/faq" className="text-gray-400 hover:text-indigo-400 transition-colors duration-200">
                  FAQ
                </Link>
              </li>
            </ul>
